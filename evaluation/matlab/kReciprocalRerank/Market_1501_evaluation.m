...
% train_feature = importdata(['D:\development\private\masters\results\kReciprocal\Market1501' netname '_IDE_train.mat']);
% train_feature = single(train_feature);
%% test info
galFea = importdata(['D:\development\private\masters\results\kReciprocal\Market1501\' netname '_IDE_test.mat']);
galFea = single(galFea);
probFea = importdata(['D:\development\private\masters\results\kReciprocal\Market1501\' netname '_IDE_query.mat']);
